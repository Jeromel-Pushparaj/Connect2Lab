<section class="d-flex justify-content-center align-items-center vh-100">
	<div class="row py-lg-5 w-75">
		<form method="post" action="machine.php" enctype="multipart/form-data">
			<div class="col-lg-8 col-md-10 mx-auto p-4 border rounded-1 text-center shadow">
				...
				<p>
					<button class="btn btn-primary me-2" type="submit" name="action" value="start">Start a Machine</button>
					<button class="btn btn-success" type="submit" name="action" value="create">Create a Machine</button>
				</p>
			</div>
		</form>
	</div>
